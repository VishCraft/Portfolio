...
export default function Contact() {
  return (
    <div
      className="rounded-xl p-8 max-w-xl fade-in delay-400"
      style={{
    ...
    >
      <p className="font-semibold text-lg mb-2 text-white">Vishal Kompella</p>
      <p className="text-white">
        Email: <span className="text-blue-300">vishalk.vce@gmail.com</span>
      </p>
      <p className="mt-2 text-white">Phone: +1 (623) 291-8019</p>
